...
-- ============================
INSERT ALL INTO EMPLOYEE (NAME, EMAIL, PHONE_NUMBER, ADDRESS, HOURLY_WAGE)
VALUES ('Ngô Tiến Sỹ', '23521367@gm.uit.edu.vn', '0941866722', 'A005, UIT-VNUHCM', 25000)
INTO EMPLOYEE (NAME, EMAIL, PHONE_NUMBER, ADDRESS, HOURLY_WAGE)
...
VALUES ('Khuyến mãi Mùa Xuân', TIMESTAMP '2025-04-01 00:00:00', TIMESTAMP '2025-05-31 23:59:59', '0123456789023', 2,
        '0123456789023', 1, 0)

-- Mua 2 tặng 1 khác loại
INTO PROMOTION (NAME, START_TIME, END_TIME, PRODUCT_ID, MINIMUM_PURCHASE_QUANTITY, PROMO_PRODUCT_ID,
                PROMO_PRODUCT_QUANTITY, DISCOUNT_RATE)
VALUES ('Khuyến mãi Mùa Hạ', TIMESTAMP '2025-04-01 00:00:00', TIMESTAMP '2025-05-31 23:59:59', '0123456789022', 2,
        '0123456789021', 1, 0)

-- Mua 2 giảm 10% khác loại
INTO PROMOTION (NAME, START_TIME, END_TIME, PRODUCT_ID, MINIMUM_PURCHASE_QUANTITY, PROMO_PRODUCT_ID,
                PROMO_PRODUCT_QUANTITY, DISCOUNT_RATE)
VALUES ('Khuyến mãi Mùa Thu', TIMESTAMP '2025-04-01 00:00:00', TIMESTAMP '2025-05-31 23:59:59', '0123456789020', 2,
        NULL, 1, 0.1)

-- Mua 3 giảm 20% tặng 1 khác loại
INTO PROMOTION (NAME, START_TIME, END_TIME, PRODUCT_ID, MINIMUM_PURCHASE_QUANTITY, PROMO_PRODUCT_ID,
                PROMO_PRODUCT_QUANTITY, DISCOUNT_RATE)
VALUES ('Khuyến mãi Mùa Đông', TIMESTAMP '2025-04-01 00:00:00', TIMESTAMP '2025-05-31 23:59:59', '0123456789019', 2,
        '0123456789018', 1, 0.2)
SELECT *
FROM DUAL;
...
BEGIN
    ...
    PRC_INITIATE_INVOICE(P_STORE_ID => 'VN000001', P_MEMBER_ID => V_MEMBER_ID, P_PAYMENT_ID => 'P001',
