...
-- ====================================
-- Existing sample
INSERT INTO MEMBER (NAME, PHONE_NUMBER, EMAIL, LOYALTY_POINTS)
VALUES ('Tạ Việt Phương', '0941234567', 'ttb@member.com', 0);

INSERT ALL
    INTO MEMBER (NAME, PHONE_NUMBER, EMAIL, LOYALTY_POINTS)
...
-- ====================================
INSERT INTO PROMOTION (NAME, START_TIME, END_TIME, PRODUCT_ID,
...
VALUES ('Khuyến mãi Mùa Xuân', TIMESTAMP '2025-04-01 00:00:00', TIMESTAMP '2025-05-31 23:59:59',
        '0123456789023', 2, '0123456789023', 1, 0);
...
VALUES ('NeoStain Trường Đại học Công nghệ Thông tin', 'Khu phố 6, P.Linh Trung, Tp.Thủ Đức, Tp.Hồ Chí Minh',
...
INSERT INTO ACCOUNT (EMPLOYEE_ID, USERNAME, PASSWORD_HASH, ROLE_ID, STATUS)
VALUES ('250515000001', 'iamsm', 'ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f', 'R001',
        'Đang hoạt động');
INSERT INTO ACCOUNT (EMPLOYEE_ID, USERNAME, PASSWORD_HASH, ROLE_ID, STATUS)
VALUES ('250515000002', 'iamcs1', 'ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f', 'R002',
        'Đang hoạt động');
INSERT INTO ACCOUNT (EMPLOYEE_ID, USERNAME, PASSWORD_HASH, ROLE_ID, STATUS)
VALUES ('250515000003', 'iamcs2', 'ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f', 'R002',
        'Đang hoạt động');
INSERT INTO ACCOUNT (EMPLOYEE_ID, USERNAME, PASSWORD_HASH, ROLE_ID, STATUS)
VALUES ('250515000004', 'iamcs3', 'ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f', 'R002',
        'Đang hoạt động');
...
BEGIN
    FOR REC IN (
        ...
        LOOP
            ...
            VALUES (REC.ID, 'VN000001', SYSTIMESTAMP, SYSTIMESTAMP + INTERVAL '4' HOUR);
        END LOOP;
END;
-- ====================================
-- 10. INVOICE (Hóa đơn)
...
BEGIN
    PRC_INITIATE_INVOICE(P_STORE_ID => 'VN000001', P_MEMBER_ID => NULL, P_PAYMENT_ID => 'P001',
                         P_EMPLOYEE_ID => '250515000001', P_POINT_USED => 0, P_INVOICE_ID => V_INVOICE_ID);
...
DECLARE
    V_INVOICE_ID INVOICE.ID%TYPE;
BEGIN
    PRC_INITIATE_INVOICE(P_STORE_ID => 'VN000001', P_MEMBER_ID => '09412345672505150001', P_PAYMENT_ID => 'P001',
                         P_EMPLOYEE_ID => '250515000001', P_POINT_USED => 0, P_INVOICE_ID => V_INVOICE_ID);
    PRC_ADD_ITEM_TO_INVOICE(P_INVOICE_ID => V_INVOICE_ID, P_PRODUCT_ID => '0123456789010', P_QUANTITY_SOLD => 5);
    PRC_ADD_ITEM_TO_INVOICE(P_INVOICE_ID => V_INVOICE_ID, P_PRODUCT_ID => '0123456789009', P_QUANTITY_SOLD => 4);
